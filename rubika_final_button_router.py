...
def _numeric_label(rb, uid, step, x):
    ...
    fa = {
        ...
        "menu": {"1":"🪪 فیدای غیر حضوری","2":"🏛 حل مشکل ورود اتباع دولت من","3":"🏛 حل مشکل ورود اتباع دولت من","4":"🎫 پیگیری","5":"📝 آزمون غربالگری","6":"📝 آزمون غربالگری","7":"💰 کیف پول من","8":"👥 پنل همکاران","9":"📞 تماس با ما","10":"🔄 شروع مجدد"},
        "main": {"1":"🪪 فیدای غیر حضوری","2":"🏛 حل مشکل ورود اتباع دولت من","3":"🏛 حل مشکل ورود اتباع دولت من","4":"🎫 پیگیری","5":"📝 آزمون غربالگری","6":"📝 آزمون غربالگری","7":"💰 کیف پول من","8":"👥 پنل همکاران","9":"📞 تماس با ما","10":"🔄 شروع مجدد"},
            ...
            def patch(r):
                ...
                def main_rows(uid):
                    ...
                    if lang == "en":
                        ...
                        rows = [[("1", "🪪 فیدای غیر حضوری"), ("2", "__REMOVED_PRINT_SERVICE__")],[("3", "🏛 حل مشکل ورود اتباع دولت من"), ("4", "🎫 پیگیری")],[("5", "__REMOVED_SIM_SERVICE__"), ("6", "📝 آزمون غربالگری و پیگیری")],[("7", "💰 کیف پول من"), ("8", "👥 پنل همکاران")],[("9", "📞 تماس با ما"), ("10", "🔄 شروع مجدد")]]
