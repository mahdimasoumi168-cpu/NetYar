...
def _split_main_rows(rb,uid):
    ...
    if l=="en": return [[("1","🪪 FIDA non-in-person")],[("2","🏛 Government access issue"),("3","🎫 Tracking")],[("4","📝 Screening test"),("5","💰 My wallet")],[("6","👥 Partner panel"),("7","📞 Contact us")],[("8","❌ Cancel"),("0","⬅️ Back")]]
    if l=="ar": return [[("1","🪪 خدمة فيدا")],[("2","🏛 مشكلة خدمات الحكومة"),("3","🎫 متابعة")],[("4","📝 اختبار الفحص"),("5","💰 محفظتي")],[("6","👥 لوحة الشركاء"),("7","📞 اتصل بنا")],[("8","❌ إلغاء"),("0","⬅️ رجوع")]]
    return [[("1","🪪 فیدای غیر حضوری")],[("2","🏛 حل مشکل ورود اتباع دولت من"),("3","🎫 پیگیری")],[("4","📝 آزمون غربالگری"),("5","💰 کیف پول من")],[("6","👥 پنل همکاران"),("7","📞 تماس با ما")],[("8",rb.CANCEL),("0","⬅️ بازگشت")]]
