...
import server
NETYAR_TELEGRAM_BUILD="2026-09-17-admin-night-worker-final-v3"
...
def _install_telegram_layers(app,bot,logger):
    ...
    # Night-worker logic is installed first; the canonical admin cleanup is
    # deliberately LAST so no legacy admin module can overwrite its menu.
    ...
    logger.info("FINAL Telegram admin menu owner installed: canonical cleanup + night controls")
def main():
