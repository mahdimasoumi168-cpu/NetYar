...
def _split_main_rows(rb,uid):
    ...
    if l=="en": return [[("1","🪪 FIDA non-in-person"),("2","🖨 Printing")],[("3","🏛 Government access issue"),("4","🎫 Tracking")],[("5","📝 Screening test"),("6","💰 My wallet")],[("7","👥 Partner panel"),("8","📞 Contact us")],[("9","❌ Cancel"),("0","⬅️ Back")]]
    if l=="ar": return [[("1","🪪 خدمة فيدا"),("2","🖨 الطباعة")],[("3","🏛 مشكلة خدمات الحكومة"),("4","🎫 متابعة")],[("5","📝 اختبار الفحص"),("6","💰 محفظتي")],[("7","👥 لوحة الشركاء"),("8","📞 اتصل بنا")],[("9","❌ إلغاء"),("0","⬅️ رجوع")]]
    return [[("1","🪪 فیدای غیر حضوری"),("2","🖨 خدمات چاپ")],[("3","🏛 حل مشکل ورود اتباع دولت من"),("4","🎫 پیگیری")],[("5","📝 آزمون غربالگری"),("6","💰 کیف پول من")],[("7","👥 پنل همکاران"),("8","📞 تماس با ما")],[("9",rb.CANCEL),("0","⬅️ بازگشت")]]
...
async def _initialize_integrations():
    ...
    try:
        ...
        telegram_ready=True
        log.info("Telegram long polling started successfully; updater.running=%s",getattr(updater,"running",False))
    except Exception:
