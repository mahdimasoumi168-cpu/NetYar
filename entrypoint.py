...
import server
NETYAR_TELEGRAM_BUILD="2026-09-17-admin-button-v3"
...
def _install_telegram_layers(app,bot,logger):
    ...
    _install_module("telegram_final_iranian_menu_v37",app,bot,logger)
    _install_module("telegram_final_iranian_menu_v38",app,bot,logger)
    _install_module("telegram_ui_universal_hotfix_v40",app,bot,logger)
    _install_module("telegram_ui_absolute_owner_v41",app,bot,logger)
    _install_module("telegram_ui_absolute_owner_v42",app,bot,logger)
    _install_module("telegram_ui_absolute_owner_v43",app,bot,logger)
    _install_module("telegram_universal_callback_owner_v46",app,bot,logger)
    _install_module("telegram_final_requirements_guard_v1",app,bot,logger)
    _install_module("telegram_admin_button_final_v1",app,bot,logger)
def main():
