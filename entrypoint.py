...
import server
NETYAR_TELEGRAM_BUILD="2026-09-17-admin-firewall-v2"
...
def _install_telegram_layers(app,bot,logger):
    ...
    _install_module("telegram_admin_ui_firewall_v1",app,bot,logger)
    logger.info("FINAL Telegram admin UI owner + firewall installed")
def main():
