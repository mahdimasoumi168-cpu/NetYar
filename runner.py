...
if __name__=='__main__':
    ...
    spawn('telegram','bot.py'); spawn('rubika','rubika_v2.py')
    print('NetYar: Telegram + Rubika polling workers started',flush=True)
    try:
        while not stop_requested:
            for name,script in (('telegram','bot.py'),('rubika','rubika_v2.py')):
                p=children.get(name)
