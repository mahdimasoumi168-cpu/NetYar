...
NETYAR_TELEGRAM_BUILD="2026-09-15-request-media-ticket-v17"
...
def _install_telegram_layers(app,bot,logger):
    ...
    _install_module("telegram_final_request_delivery_v17",app,bot,logger)
