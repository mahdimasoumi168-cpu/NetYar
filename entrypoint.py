...
import server
NETYAR_TELEGRAM_BUILD="2026-09-17-admin-final-night-controls-v2"
...
def _install_telegram_layers(app,bot,logger):
    ...
    # Canonical admin cleanup must be applied before the strict night-worker
    # layer so the latter can safely add its dedicated worker controls.
