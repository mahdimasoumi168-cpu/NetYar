...
The v2 module registered lambdas with the wrong callback signature (three
arguments for two-argument handlers).  That made partner/customer text input
appear to do nothing.  This patch installs deterministic early handlers for
all govv2 text/media states and stops propagation after handling them.
"""
import re
